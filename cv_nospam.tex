...
\cvline{DevOps}{GCP, AWS, Kubernetes, Docker, Terraform, Ansible, Vault, CI/CD, \textit{Infra as Code}}
...
\cventry{Depuis Juin 2019}{Renault/Renault Digital}{Plessis-Robinson/Boulogne}{Référent DevOps}{}{
  \begin{itemize}
