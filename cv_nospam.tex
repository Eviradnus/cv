...
\firstname{Vincent}
\familyname{Cornet}
\title{Architecte Applicatif Expert Java}
...
\cvline{Test}{Junit, TestNG, Mockito, WireMock, Cucumber, JGiven, Test Containers, Postman, SoapUI, \textit{Test/Behaviour Driven Design}}
\cvline{DevOps}{GCP, AWS, Kubernetes, Docker, Terraform, Ansible, Vault, CI/CD, \textit{Infra as Code}}
\cvline{Data}{PostgreSQL, Oracle, HSQLDB/H2, Sybase, ElasticSearch, Kafka}
...
\cventry{Depuis Sept. 2021}{DPD Group}{Issy-les-Moulineaux (92)}{Développeur Java}{}{
  \begin{itemize}
